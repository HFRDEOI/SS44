...
(function (CloudExperienceHost) {
    ...
    (function (Cortana) {
        ...
        function shouldSkipCortanaInAAD() {
            try {
                if (!cortanaManager) {
                    try {
                        cortanaManager = new CloudExperienceHostBroker.Cortana.OOBECortanaManager();
                    } catch (e) {
                        // some failure occured, should skip true
                        return true;
                    }
                }

                let allowed = cortanaManager.isCortanaPageInAADAllowed;
                return !allowed;
            }
            catch (error) {
                return true;
        ...
        Cortana.ShouldSkipCortanaInAAD = shouldSkipCortanaInAAD;
